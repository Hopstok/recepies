...
# [ -f swagger-codegen-cli.jar ] || curl 'http://central.maven.org/maven2/io/swagger/swagger-codegen-cli/2.2.3/swagger-codegen-cli-2.2.3.jar' -o swagger-codegen-cli.jar
